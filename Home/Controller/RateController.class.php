...
class RateController extends CommonController{
   ...
   public function addVipLevel_set()
   {
    ...
    public function server()
    {
	   ...
	   $ShangPin_HyMaiSp	 =D('WIni')->getOneRecordByName('ShangPin_HyMaiSp');  
       $oneserverinfo['ShangPin_HyMaiSp']=strtolower($ShangPin_HyMaiSp);
	   
	   $ShangPin_HyJlje	 =D('WIni')->getOneRecordByName('ShangPin_HyJlje');  
       $oneserverinfo['ShangPin_HyJlje']=strtolower($ShangPin_HyJlje);
    ...
    {  
     ...
     //页面6
       ...
       $m_Jifen_Jiangli    =I('post.qt_viplever_jf','0','string');
	    ...
	    $ShangPin_HyMaiSp     =I('post.ShangPin_HyMaiSp','','string');
		$ShangPin_HyJlje    =I('post.ShangPin_HyJlje','0','string');
		
	   if(!empty($ShangPin_HyMaiSp))
       {
         $ShangPin_HyMaiSp=1;
       }
       else
	   ...
	   $res=D('WIni')->postOneRecord('ShangPin_HyMaiSp',$ShangPin_HyMaiSp);     // 允许会员卡买商品
       $aTempstr=D('WIni')->getLastSql();
       $sendstr.=$aTempstr.';';  
	   
	   $res=D('WIni')->postOneRecord('ShangPin_HyJlje',$ShangPin_HyJlje);     // 允许奖励买商品
       $aTempstr=D('WIni')->getLastSql();
       $sendstr.=$aTempstr.';'; 
 ...
 $this->assign('FAllowNewproductCk',$FAllowNewproductCk);
    ...
    {    
        ...
        {   
			...
			$jch_qx=I('post.jch_qx','0','string');			      
            $sxj_qx=I('post.sxj_qx','0','string');
            $spinfo_qx=I('post.spinfo_qx','0','string');
            ...
            //分割 groupqx
			 ...
			 $groupuser_insert_data['jch_qx']=$jch_qx;			       
             $groupuser_insert_data['sxj_qx']=$sxj_qx;
             $groupuser_insert_data['spinfo_qx']=$spinfo_qx;
    ...
    public function yggroup_edit()
    {
	  ...
	  $sxj_qx=$one_groupinfo['sxj_qx'];
	  $jh_qx=$one_groupinfo['jch_qx'];
	  $ch_qx=$one_groupinfo['ch_qx'];
      $spinfo_qx=$one_groupinfo['spinfo_qx'];
	  $xiajia_qx=$one_groupinfo['xiajia_qx'];
	 ...
	 // return;
      ...
      $this->assign('bianhao',$id);		
      $this->assign('checkboxlist',$checkboxlist.$weblist.$spinfo_qx_str.$sxj_qx_str.$th_qx_str.$jh_qx_str.$xiajia_qx_str.$ch_qx_str);	
      $this->assign('groupname',$groupname);
	  

      $this->assign('th_qx',$th_qx);
      $this->assign('sxj_qx',$sxj_qx);  
      $this->assign('jch_qx',$jch_qx);
	  $this->assign('ch_qx',$ch_qx);
	  $this->assign('xiajia_qx',$xiajia_qx);
      $this->assign('spinfo_qx',$spinfo_qx);
      $this->display();
...
$ch_qx=I('post.ch_qx','0','string'); 
			
            $sxj_qx=I('post.sxj_qx','0','string');
            $spinfo_qx=I('post.spinfo_qx','0','string');
			$xiajia_qx=I('post.xiajia_qx','0','string');
            ...
            $groupuser_update_data['th_qx']  =$th_qx;
      		$groupuser_update_data['jch_qx']  =$jch_qx;
$groupuser_update_data['ch_qx']  =$ch_qx; 			
      		$groupuser_update_data['sxj_qx']  =$sxj_qx;
			$groupuser_update_data['xiajia_qx']  =$xiajia_qx;
            $groupuser_update_data['spinfo_qx']  =$spinfo_qx;
